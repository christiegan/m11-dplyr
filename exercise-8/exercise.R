...
# Read in the data
pulitzer <- read.csv("C;/Users/Christie Gan/Desktop/INFO201/m11-dplyr/data/pulitzer-circulation-data.csv", stringsAsFactors = FALSE)
